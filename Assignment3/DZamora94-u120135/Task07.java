...
public class Task07 {
	...
	public static void main(String args[]) {
		...
		OntModel model = ModelFactory.createOntologyModel(OntModelSpec.RDFS_MEM_RDFS_INF, model);
		OntClass person = model.getOntClass(ns + "Person");
		
		ExtendedIterator<OntClass> listSubclass = person.listSubClasses();
		ExtendedIterator<Individual> listInstances = person.listInstances();
