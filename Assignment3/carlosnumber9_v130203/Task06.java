 ...
 * @author Carlos Pinedo Sanchez v130203
 *
 */
...
public class Task06 {
	...
	public static void main(String args[]) {
		...
		OntClass rsch = model.createClass(ns + "Researcher");
		...
		// **
		Individual janeSmith = rsch.createIndividual(ns + "Jane Smith");

		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and
		// family names **
