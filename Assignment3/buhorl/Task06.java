<<<<<<< HEAD:Assignment3/buhorl/src/main/java/upm/oeg/wsld/jena/Task06.java
...
public class Task06
{
	...
	public static String w3 = "http://www.w3.org/2001/vcard-rdf/3.0#";
	...
	public static void main(String args[])
	{
		...
		Resource persona = model.getResource(ns+"Person");
		researcher.addSuperClass(persona);

		// ** TASK 6.3: Create a new property named "worksIn" **

		Property trabajaEn = model.createProperty(w3+"worksIn");

		// ** TASK 6.4: Create a new individual of Researcher named "Jane Smith" **
		
		Individual JaS = researcher.createIndividual(ns+"Jane Smith");

		// ** TASK 6.5: Add to the individual JaneSmith the fullName, given and family names **
		
		JaS.addProperty(VCARD.FN, "Jane Smith");
		JaS.addProperty(VCARD.Given, "Jane");
		JaS.addProperty(VCARD.Family, "Smith");

		// ** TASK 6.6: Add UPM as the university where John Smith works **

		Individual JoS = researcher.createIndividual(ns+"John Smith");
		Individual UPM = uni.createIndividual(ns+"UPM");
		JoS.addProperty(trabajaEn, UPM);
...
>>>>>>> dbee99cf1c10ee002e5fb986970aa20635091478:Assignment3/src/main/java/upm/oeg/wsld/jena/Task06.java
