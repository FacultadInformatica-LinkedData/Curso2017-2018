...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Property worksIn = model.createProperty("http://example.org/App/worksIn");
		...
		janeSmith.addLiteral(VCARD.FN, fullName2);
		janeSmith.addLiteral(VCARD.Family, familyName2);
