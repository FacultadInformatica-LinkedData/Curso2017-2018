...
public class Task07
{
	...
	public static void main(String args[])
	{
		...
		ExtendedIterator<?> subs = person.listSubClasses();


		while (subs.hasNext())
		{
			OntClass sub = (OntClass) subs.next();
			ExtendedIterator<?> inds = sub.listInstances();
			while (inds.hasNext())
			{
				OntResource ind = (OntResource) inds.next();
				System.out.println("Subclass of Person: "+sub.getURI());
				System.out.println("Indirect Instance of Person: "+ind.getURI());
			}
		}
